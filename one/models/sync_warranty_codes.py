...
class SyncWarrantyCodes(models.Model):
    _inherit = "res.company"
    
    @api.multi
    def sync_warranty_codes(self):
        ...
        # get entire warranty codes from product_template
        fmpi_pts = models.execute_kw(db, uid, password,
            'product.template', 'search_read',[[('sub_type','=','warranty')]], 
                ...
                if not dealer_pts:
                    ...
                    if fmpi_pt_full_detail:
                        values = {
                            ...
                            'categ_id': self.warranty_categ_id.id,                             
